...
const NotificationItem: React.FC<{ notification: Notification }> = ({ notification }) => {
    ...
    return (
        <div className={`flex items-start gap-3 p-3 transition-colors duration-200 ${!read ? 'bg-indigo-50 dark:bg-slate-700/50' : ''} hover:bg-slate-100 dark:hover:bg-slate-700`}>
            {renderIcon()}
        ...
        <div className="fixed inset-0 z-40" onClick={onClose}>
            ...
            >
                <div className="flex items-center justify-between p-3 border-b dark:border-slate-700">
                    ...
                    <button onClick={onMarkAllAsRead} className="text-sm font-semibold text-indigo-600 dark:text-indigo-400 hover:underline">
